...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring("root://xrootd-cms.infn.it///store/hidata/OORun2025/IonPhysics0/MINIAOD/PromptReco-v1/000/394/217/00000/9c50ae99-8f1c-4a59-82dd-75e6ca3a05bf.root"),
)
process.maxEvents = cms.untracked.PSet(input = cms.untracked.int32(10000))#-1))

# Set the global tag
process.load('Configuration.StandardSequences.FrontierConditions_GlobalTag_cff')
process.GlobalTag.globaltag = cms.string('150X_dataRun3_Prompt_v3')
...
process.diKaEvtSel = cms.Sequence(process.twoTracks * process.goodTracks * process.twoGoodTracks * process.goodKaons * process.goodDiKaons * process.oneGoodDiKa)
...
process.hltFilter.HLTPaths = [
    # UPC ZB triggers
    'HLT_OxyZeroBias_SinglePixelTrackLowPt_MaxPixelCluster400_v*',
    'HLT_OxyZeroBias_MinPixelCluster400_v*',
    'HLT_OxyZeroBias_v*',
    # UPC ZDC OR triggers
    'HLT_OxyZDC1nOR_v1',
]
...
trig_info = cms.untracked.VPSet([
    # UPC ZB triggers
    cms.PSet(path = cms.string('HLT_OxyZeroBias_SinglePixelTrackLowPt_MaxPixelCluster400_v*'), filter = cms.string('hltSinglePixelTrackLowPtForOxy'), minN = cms.int32(1)),
    cms.PSet(path = cms.string('HLT_OxyZeroBias_MinPixelCluster400_v*')),
    cms.PSet(path = cms.string('HLT_OxyZeroBias_v*')),
    # UPC ZDC OR triggers
    cms.PSet(path = cms.string('HLT_OxyZDC1nOR_v*')),
])
