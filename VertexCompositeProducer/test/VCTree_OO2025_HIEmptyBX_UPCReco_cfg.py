...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring("root://xrootd-cms.infn.it///store/hidata/OORun2025/EmptyBX/MINIAOD/PromptReco-v1/000/394/209/00000/efbecbd7-9896-43d1-a529-372ea1bd5be7.root"),
)
...
process.hltFilter.HLTPaths = [
    # Empty BX triggers
    'HLT_HIL1NotBptxORForPPRef_v*',
    'HLT_HIL1UnpairedBunchBptxMinusForPPRef_v*',
    'HLT_HIL1UnpairedBunchBptxPlusForPPRef_v*'
]
...
trig_info = cms.untracked.VPSet([
    # EmptyBX triggers
    cms.PSet(path = cms.string('HLT_HIL1NotBptxORForPPRef_v*')),
    cms.PSet(path = cms.string('HLT_HIL1UnpairedBunchBptxMinusForPPRef_v*')),
    cms.PSet(path = cms.string('HLT_HIL1UnpairedBunchBptxPlusForPPRef_v*')),
])
